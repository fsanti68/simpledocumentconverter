...
import com.logicalis.br.sdc.converters.ConvertCSVToXLS;

public class ConvertCSVToXLSTest extends ConverterTest {
	...
	public void testConvert() throws Exception {
		...
		Converter converter = new ConvertCSVToXLS();
		byte[] doc = converter.convert(getConfig(), baos.toByteArray());

		File f = new File("/tmp/generated_from_csv.xls");
