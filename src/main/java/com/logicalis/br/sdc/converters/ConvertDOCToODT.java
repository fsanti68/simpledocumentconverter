...
/**
 * Convert from Excel spreadsheet to Open Office spreadsheet - ods, using Open
 * Office command line tool.
 * 
 * @author Fabio De Santi
 *
 */
public class ConvertDOCToODT implements Converter {

	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	private final String FROM = "doc";
	private final String TO = "odt";
